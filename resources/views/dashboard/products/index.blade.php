        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.products') <small style="font-size: larger; color:#3c8dbc;">{{ $products->total() }}</small></h3>
                    ...
                    <form action="{{ route('dashboard.products.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                {{-- @else
                                    <a href="{{route('dashboard.products.add')}}" class="btn btn-primary disabled"><i class="fa fa-plus"></i> @lang('site.add')</a> --}}
                                    @endif
