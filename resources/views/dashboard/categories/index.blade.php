        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.categories') <small style="font-size: larger; color:#3c8dbc;">{{ $categories->total() }}</small></h3>
                    ...
                    <form action="{{ route('dashboard.categories.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                {{-- @else
                                    <a href="{{route('dashboard.categories.add')}}" class="btn btn-primary disabled"><i class="fa fa-plus"></i> @lang('site.add')</a> --}}
                                    @endif
                    ...
                    @if ($categories->count() > 0)
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                {{-- @if (auth()->user()->hasPermission('categories_update','categories_delete'))
