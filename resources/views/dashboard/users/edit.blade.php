        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form action="{{ route('dashboard.users.update',$users->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <img src="{{ asset($users->image) }}" style="width: 100px"
                    ...
                    <div class="tabe-content">
                             ...
                             <div class="tabe-pane {{$index == 0 ? 'active' : ''}}" id="{{$model}}">
                                ...
                                @foreach ($maps as $map)
                                <label><input type="checkbox" name="permissions[]" {{$users->hasPermission($model.'_'.$map) ? 'checked' : ''}} value="{{$model}}_{{$map}}">@lang('site.'.$map)</label>
                                @endforeach
