        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.users') <small style="font-size: larger; color:#3c8dbc;">{{ $users->total() }}</small></h3>
                    ...
                    <form action="{{ route('dashboard.users.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                {{-- @else
                                    <a href="{{route('dashboard.users.add')}}" class="btn btn-primary disabled"><i class="fa fa-plus"></i> @lang('site.add')</a> --}}
                                    @endif
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($users as $index=>$user)
                                <tr>
                                    ...
                                    <td>{{ $user->email }}</td>
                                    <td><img src="{{ asset($user->image)}}" width="100" height="100" class="img-thumbnail" alt=""></td>
                                    <td>
